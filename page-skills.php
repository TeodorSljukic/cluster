...
<main class="blog-archive container">
  ...
  <p class="archive-subtitle" data-aos="fade-up" data-aos-delay="100">
    Discover key skills and competencies that support sustainable growth and innovation in the Adriatic region.
  </p>
  ...
  <div class="posts-grid">
    <?php
      ...
      if ($skills_query->have_posts()) :
        ...
        <?php 
          $delay += 100;
          if ($delay > 400) $delay = 100; // reset poslije 4 kartice
        endwhile;
      else :
  ...
  <div class="pagination" data-aos="fade-up" data-aos-delay="200">
    <?php
      echo paginate_links(array(
        'total'   => $skills_query->max_num_pages,
        'current' => $paged,
        'mid_size'  => 2,
        'prev_text' => __('« Prev'),
        'next_text' => __('Next »'),
